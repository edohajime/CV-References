...
public class CategoryObject extends SectionObject {
	...
	// Thuộc tính dùng để đếm số bài viết
	private int category_article_count;
	...
	public CategoryObject() {
		...
		this.category_name = "";
		this.category_notes = "";
		this.category_created_date = "";
		this.category_manager_id = 0;
		this.category_enable = false;
		this.category_delete = false;
		this.category_last_modified = "";
		this.category_created_author_id = 0;
		this.category_name_en = "";
		this.category_image = "";
		this.category_language = 0;
	}
	...
	/**
	 * @param category_notes the category_notes to set
	 */
	...
	/**
	 * @param category_created_date the category_created_date to set
	 */
	...
	/**
	 * @param category_manager_id the category_manager_id to set
	 */
	...
	/**
	 * @param category_enable the category_enable to set
	 */
	...
	/**
	 * @param category_delete the category_delete to set
	 */
	...
	/**
	 * @param category_last_modified the category_last_modified to set
	 */
	...
	/**
	 * @param category_created_author_id the category_created_author_id to set
	 */
	...
	/**
	 * @param category_name_en the category_name_en to set
	 */
	...
	/**
	 * @param category_image the category_image to set
	 */
	...
	/**
	 * @param category_language the category_language to set
	 */
	...
	/**
	 * @param category_section_id the category_section_id to set
	 */
	...
	/**
	 * @return the category_article_count
	 */
	public int getCategory_article_count() {
		return category_article_count;
	}


	/**
	 * @param category_article_count the category_article_count to set
	 */
	public void setCategory_article_count(int category_article_count) {
		this.category_article_count = category_article_count;
	}
