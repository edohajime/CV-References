...
public class SectionObject {
	...
	public SectionObject() {
		...
		this.section_name = "";
		this.section_notes = "";
		this.section_created_date = "";
		this.section_manager_id = 0;
		this.section_enable = false;
		this.section_delete = false;
		this.section_last_modified = "";
		this.section_created_author_id = 0;
		this.section_name_en = "";
		this.section_language = 0;
	}
	...
	/**
	 * @param section_notes the section_notes to set
	 */
	...
	/**
	 * @param section_created_date the section_created_date to set
	 */
	...
	/**
	 * @param section_manager_id the section_manager_id to set
	 */
	...
	/**
	 * @param section_enable the section_enable to set
	 */
	...
	/**
	 * @param section_delete the section_delete to set
	 */
	...
	/**
	 * @param section_last_modified the section_last_modified to set
	 */
	...
	/**
	 * @param section_created_author_id the section_created_author_id to set
	 */
	...
	/**
	 * @param section_name_en the section_name_en to set
	 */
	...
	/**
	 * @param section_language the section_language to set
	 */
