...
public class ArticleObject extends CategoryObject{
	...
	/**
	 * @param article_author_permission the article_author_permission to set
	 */
	...
	/**
	 * @param article_forhome the article_forhome to set
	 */
