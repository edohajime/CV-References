...
const ProductDetail = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const url = `http://localhost:8000/add-order`;
    ...
    /**
     * Hàm xử lý khi chọn vào attribute của sản phẩm
     * @param {*} e - Event
     * @param {*} attr - Tên attribute, dùng để điền vào trường nhập tương ứng
     * @param {*} index - Vị trí trong mảng một chiều attribute
     * @param {*} ops - Tùy chọn select
     * @param {*} attrId - ID tương ứng với giá trị attribute của sản phẩm trong database
     */
    const handleAttributes = (e, attr, index, ops, attrId = 0) => {
        handleSelect(e, ops);
        ...
        if (attr === "color") {
            row = index;
            if (color) {
                e.parentNode.querySelector('input[name="color"]').value =
                    attrId;
            } else {
                e.parentNode.querySelector('input[name="color"]').value = null;
            }
            ...
            col = index;
            if (size) {
                e.parentNode.querySelector('input[name="size"]').value = attrId;
            } else {
                e.parentNode.querySelector('input[name="size"]').value = null;
            }
            setSizeId(attrId);
        }
                ...
                <Row>
                    <Col className="reviews" xs={10}>
                        <div className="reviews-header">
                            ...
                            <ReviewAddModal colorId={colorId} sizeId={sizeId} />
                        </div>
