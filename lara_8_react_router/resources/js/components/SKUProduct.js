...
const SKUProduct = () => {
    ...
    // Xử lý logic để cập nhật giá trị của `showButton`
    useEffect(() => {
        // Kiểm tra xem có item.sku nào có giá trị null không
        const hasNullSku = data.some(
            (item) => item.sku === null || item.sku === ""
        );
        // Cập nhật giá trị của state `showButton` dựa trên kết quả kiểm tra
        setShow(!hasNullSku);
    }, [data]);
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="card shadow mb-4">
                                <div className="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 className="m-0 font-weight-bold text-primary">
                                        Mã hàng hóa (Chỉ có thể đổi một lần)
                                    </h6>
                                </div>
                            ...
                            <Row>
                                ...
                                >
                                    ...
                                    {/* Render nút cập nhật chỉ khi điều kiện `showButton` đúng */}
                                    {!show && (
                                        <button
                                            type="submit"
