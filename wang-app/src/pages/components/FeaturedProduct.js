...
const FeaturedProduct = () => {
  return (
    <div className="comingSoon featuredProduct">
      <Container>
        <Row className="comingSoon-header align-items-center">
          <Col xs={7}>
            <h1 className="comingSoon-title">SẢN PHẨM NỔI BẬT</h1>
          </Col>
        ...
        <Row className="featuredProduct-footer">
          <Col>
            <h5 className="featuredProduct-expand">Xem thêm</h5>
          </Col>
        </Row>
      </Container>
    </div>
