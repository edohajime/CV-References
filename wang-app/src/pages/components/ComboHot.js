    ...
    <div className="comboHot">
      <Container>
        <Row className="comboHot-header">
          <Col xs={6}>
            <h1 className="comboHot-title">MUA COMBO HOT</h1>
          </Col>
          <Col xs={6} className="text-end">
            <h5 className="comboHot-expand">Xem {">>"}</h5>
          </Col>
        </Row>
          ...
          <Col xs={12} className="comboHot-section">
            ...
            <Row>
              ...
              <Col xs={5} className="comboHot-label">
                <h3>Combo 4 sản phẩm</h3>
                <div className="comboHot-saleSticker">50%</div>
              </Col>
            </Row>
            <Row className="align-items-end">
              <Col xs={7} className="comboHot-sale">
