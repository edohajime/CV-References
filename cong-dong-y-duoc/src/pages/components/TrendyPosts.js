...
const TrendyPosts = () => {
  return (
    <div className="popularposts trendyposts">
      <Container>
        <div className="header">
          <div className="mark"></div>
          <h3 className="header-title">Trendy Posts</h3>
        </div>
        <Row className="popularposts-posts">
          <Col xs={3} className="popularpost visible">
            <div className="popularposts-item">
              <img
                src="/imgs/trendyposts/trendyposts-item_1.jpg"
                alt="trendyposts"
              />
              ...
              <div className="popularposts-author">
                <img
                  src="/imgs/trendyposts/authors/trendyposts-authors-item_1.jpg"
                  alt="authors"
                />
          ...
          <Col xs={3} className="popularpost visible">
            <div className="popularposts-item">
              <img
                src="/imgs/trendyposts/trendyposts-item_2.jpg"
                alt="trendyposts"
              />
              ...
              <div className="popularposts-author">
                <img
                  src="/imgs/trendyposts/authors/trendyposts-authors-item_2.jpg"
                  alt="authors"
                />
                <div className="author-info">
          ...
          <Col xs={3} className="popularpost visible">
            <div className="popularposts-item">
              <img
                src="/imgs/trendyposts/trendyposts-item_3.jpg"
                alt="trendyposts"
              />
              ...
              <div className="popularposts-author">
                <img
                  src="/imgs/trendyposts/authors/trendyposts-authors-item_3.jpg"
                  alt="authors"
                />
                <div className="author-info">
                  <h5>Mary</h5>
          ...
          <Col xs={3} className="popularpost visible">
            <div className="popularposts-item">
              <img
                src="/imgs/trendyposts/trendyposts-item_4.jpg"
                alt="trendyposts"
              />
              ...
              <div className="popularposts-author">
                <img
                  src="/imgs/trendyposts/authors/trendyposts-authors-item_4.jpg"
                  alt="authors"
                />
                <div className="author-info">
                  <h5>Jon Kantner</h5>
